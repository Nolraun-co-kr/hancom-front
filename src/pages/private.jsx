          ...
          <div className="private__content">
            <div className="wrap">
              ...
              <div className="private__txt">
                ...
                이 약관은 (주)한글과컴퓨터(이하 “회사”)가 제공하는 회사의 제반 서비스 이용과 관련하여 회사와 회원과의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.
                ...
                <strong>제 7조 회원의 아이디 및 비밀번호의 관리에 대한 의무</strong>
                ...
                <strong>제 8조 연결서비스와 피연결서비스 간의 관계</strong>
                ...
                <strong>제 14조 정보의 제공 및 광고의 게재</strong>
                ...
                <strong>제 17조 계약해제, 해지, 휴면 등</strong>
                ...
                <strong>제 18조 이용제한 등</strong>

                ① 회사는 회원이 이 약관의 의무를 위반하거나 서비스의 정상적인 운영을 방해한 경우, 경고, 일시정지, 영구이용정지 등으로 서비스 이용을 단계적으로 제한할 수 있습니다.
                ② 회사는 전항에도 불구하고, 타인의 명의(이름 및 이메일주소 등)도용 및 결제도용, 저작권법을 위반한 불법프로그램의 제공 및 운영방해, 정보통신망법을 위반한 불법통신 및 해킹, 악성프로그램의 배포, 접속권한 초과행위 등과 같이 관련법을 위반한 경우에는 즉시 영구이용정지를 할 수 있습니다. 본 항에 따른 영구이용정지 시 서비스 이용을 통해 획득한 쿠폰 및 기타 혜택 등도 모두 소멸되며, 회사는 이에 대해 별도로 보상하지 않습니다.
                ...
                (부칙) 이 약관은 2016년 10월 15일부터 적용됩니다. 종전의 약관은 본 약관으로 대체합니다.
